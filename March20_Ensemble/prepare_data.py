...
def prepare_data():
    # Adjusted path assuming this script is run from inside March20_Ensemble
    ...
    # We will use the first 4 targets: B, Cu, Zn, Fe
    targets = ['B', 'Cu', 'Zn', 'Fe']
    ...
    for i, row in df.iterrows():
        ...
        if fpath.exists():
            ...
            # Reduce 3D patch to 1D spectrum if needed
            if arr.ndim == 3:
